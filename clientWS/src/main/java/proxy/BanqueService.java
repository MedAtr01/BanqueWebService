...
public interface BanqueService {
    ...
    @RequestWrapper(localName = "convertEuToMad", targetNamespace = "http://ws/", className = "proxy.ConvertEuToMad")
    @ResponseWrapper(localName = "convertEuToMadResponse", targetNamespace = "http://ws/", className = "proxy.ConvertEuToMadResponse")
    @Action(input = "http://ws/BanqueService/convertEuToMadRequest", output = "http://ws/BanqueService/convertEuToMadResponse")
    public double convertEuToMad(
